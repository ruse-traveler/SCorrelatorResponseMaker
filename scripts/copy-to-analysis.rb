...
copy_to   = "/sphenix/user/danderson/sphenix/analysis/AndersonAnalysisModules/ColdQcdCorrelatorAnalysis/SCorrelatorResponseMaker"
...
to_copy = [
  ...
  "src/SCorrelatorResponseMaker.io.h",
